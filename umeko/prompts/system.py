...
- 用户提供多份素材（多份文档/图片）或需求复杂：先逐份获取素材内容，
  write_working_doc 整合成工作文档，不要把大量素材原文长期堆在对话上下文里；
- 用户要求调整中间文档或输出为其它格式的文件：grep_files 定位、replace_in_file
  精确替换、write_file 新建/覆盖；改动前先 read_document 拿到原文；
